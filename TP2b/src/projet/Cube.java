...
public class Cube implements GLEventListener {
    ...
    public void display(GLAutoDrawable gLDrawable) {
        ...
        gl.glVertex3f(0.0f, 1.0f, 0.0f); // Set a point at top left
        gl.glVertex3f(1.0f, 1.0f, 0.0f); // Set a point at top right
        gl.glVertex3f(1.0f, 0.0f, 0.0f); // Set a point at bottom right
        gl.glVertex3f(0.0f, 0.0f, 0.0f); // Set a point at bottom left
        gl.glEnd();

         // Draw a square :
         gl.glBegin(GL2.GL_QUADS);
         gl.glColor3f(0.0f, 1.0f, 0.0f); // Set the color for the next drawing
         gl.glVertex3f(0.0f, 0.0f, 0.0f); // Set a point at top left
         gl.glVertex3f(0.0f, 1.0f, 0.0f); // Set a point at top right
         gl.glVertex3f(0.0f, 1.0f, 1.0f); // Set a point at bottom right
         gl.glVertex3f(0.0f, 0.0f, 1.0f); // Set a point at bottom left
         gl.glEnd();
        ...
        gl.glVertex3f(0.0f, 1.0f, 0.0f); // Set a point at top left
        gl.glVertex3f(0.0f, 1.0f, 1.0f); // Set a point at top right
        ...
        gl.glEnd();
         ...
         gl.glVertex3f(1.0f, 0.0f, 0.0f); // Set a point at top left
         gl.glVertex3f(1.0f, 1.0f, 0.0f); // Set a point at top right
         gl.glVertex3f(1.0f, 1.0f, 1.0f); // Set a point at bottom right
         gl.glVertex3f(1.0f, 0.0f, 1.0f); // Set a point at bottom left
         gl.glEnd();
        ...
        gl.glVertex3f(0.0f, 0.0f, 0.0f); // Set a point at top left
        gl.glVertex3f(1.0f, 0.0f, 0.0f); // Set a point at top right
        gl.glVertex3f(1.0f, 0.0f, 1.0f); // Set a point at bottom right
        gl.glVertex3f(0.0f, 0.0f, 1.0f); // Set a point at bottom left
        gl.glEnd();
         ...
         gl.glVertex3f(0.0f, 1.0f, 1.0f); // Set a point at top left
